...
expanded_df_no_center = expanded_df[expanded_df['bias'] != 1]
expanded_df_no_center['bias'] = expanded_df_no_center['bias'].replace(2, 1)

expanded_df_no_center.to_csv('normalizedDataNoCenter.csv')
